...
if ENV:
    ...
    from GreyRobot.config import Development as Config
    TOKEN = Config.TOKEN
...
telethn = TelegramClient("Grey", API_ID, API_HASH)
pgram = Client("GreyRobot", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
...
from GreyRobot.modules.helper_funcs.handlers import (CustomCommandHandler,
