...
import GreyRobot.modules.sql.global_bans_sql as sql
from GreyRobot.modules.sql.users_sql import get_user_com_chats
from GreyRobot import (DEV_USERS, EVENT_LOGS, OWNER_ID, STRICT_GBAN, DRAGONS,
...
from GreyRobot.modules.helper_funcs.misc import send_to_list
...
def gban(update: Update, context: CallbackContext):
    ...
    message.reply_photo(GBAN_DONE,caption="Successfully GBAN DONE!",reply_markup=InlineKeyboardMarkup(
                [
                 [
                  InlineKeyboardButton(text="View Gban ✨", url=f"https://t.me/greylogs")]],parse_mode=ParseMode.HTML)
)
