#this module only Created in @GreyRobot ©pegasusXteam
...
import GreyRobot.modules.fun_strings as fun
from GreyRobot import DEMONS, DRAGONS, dispatcher, SUPPORT_CHAT
