...
from GreyRobot.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "Tiger Chatbot disable by {}.".format(mention_html(user.id, user.first_name)),
...
def kukiadd(update: Update, context: CallbackContext) -> str:
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "Tiger Chatbot enable by {}.".format(mention_html(user.id, user.first_name)),
                parse_mode=ParseMode.HTML,
            )
