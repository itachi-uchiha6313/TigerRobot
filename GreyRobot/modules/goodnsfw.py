#this good nsfw module only created for @GreyRobot and thanks to @Everythingsuckz, all suckz removed by @Ctzfamily
import os
import html
import nekos
import requests
...
from GreyRobot import dispatcher, updater
import GreyRobot.modules.sql.nsfw_sql as sql
...
__help__ = """
Module credits: [GreyRobot](https://github.com/Ctzfamily/GreyRobot/Grey/GreyRobot/modules/goodnsfw.py) ,
