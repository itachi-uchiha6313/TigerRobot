...
import telegram
from GreyRobot import TIGERS, WOLVES, dispatcher
from GreyRobot.modules.disable import DisableAbleCommandHandler
from GreyRobot.modules.helper_funcs.chat_status import (bot_admin,
                                                           can_restrict,
                                                           is_user_admin,
                                                           user_admin,
                                                           user_admin_no_reply)
...
from GreyRobot.modules.helper_funcs.misc import split_message
from GreyRobot.modules.helper_funcs.string_handling import split_quotes
from GreyRobot.modules.log_channel import loggable
from GreyRobot.modules.sql import warns_sql as sql
...
def warn(user: User,
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # grey's sticker
        keyboard = None
