...
from GreyRobot.modules.helper_funcs.misc import article
from GreyRobot.modules.helper_funcs.decorators import greyinline as kiginline
...
def inlineinfo(query: str, update: Update, context: CallbackContext) -> None:
    ...
    if user.id == OWNER_ID:
        ...
        text += f"\n\nThis Person is Developer of Grey"
        nation_level_present = True
    ...
    if nation_level_present:
        text += ' [<a href="https://t.me/greyUpdates/167">[ RANKS ]</a>]'.format(bot.username)
    ...
    kb = InlineKeyboardMarkup(
        [
            [
                ...
                InlineKeyboardButton(
                    text="sᴜᴘᴘᴏʀᴛ",
                    url="t.me/GreySupport",
                ),
                InlineKeyboardButton(
                    text="ᴜᴘᴅᴀᴛᴇs",
                    url="t.me/GreyUpdates",
                ),
