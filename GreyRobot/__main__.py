...
from GreyRobot.modules import ALL_MODULES
from GreyRobot.modules.bot_stats import bot_sys_stats
from GreyRobot.modules.helper_funcs.chat_status import is_user_admin
from GreyRobot.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("GreyRobot.modules." + module_name)
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
               random.choice(GREY_IMG),PM_START_TEXT.format(first_name),
            ...
            query.message.edit_caption(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="⬅ ʙᴀᴄᴋ", callback_data="help_back"),
                      InlineKeyboardButton(text="⬅ ʜᴏᴍᴇ", callback_data="grey_back")]]
                ),
            )
...
def grey_about_callback(update, context):
    ...
    if query.data == "grey_":
        query.message.edit_caption(
            ...
            "\n\n Click on button bellow to get basic help for @GreyRobot.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="👮 ᴀᴅᴍɪɴs", callback_data="grey_admin"),
                    InlineKeyboardButton(text="📓 ɴᴏᴛᴇs", callback_data="grey_notes"),
                 ],
                 [
                    InlineKeyboardButton(text="💕 ᴄʜᴀɴɴᴇʟs", callback_data="grey_support"),
                    InlineKeyboardButton(text="💕 sᴛᴀᴛs", callback_data="stats_callback"),
                 ],
                 [
                    InlineKeyboardButton(text="⬅️ ʙᴀᴄᴋ", callback_data="grey_back"),
                 ]
                ]
            ),
        )
        ...
        query.message.edit_caption(
            ...
            "\nCongragulations, GreyRobot now ready to manage your group."
            "\n\n*Admin Tools*"
        ...
        query.message.edit_caption(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", url="t.me/Greysupport"),
                    InlineKeyboardButton(text="ᴜᴘᴅᴀᴛᴇs", url="https://t.me/greyupdates"),
                 ],
                 [
                       InlineKeyboardButton(text="ɴᴇᴛᴡᴏʀᴋ", url="t.me/XForceNetwork"),
                       InlineKeyboardButton(text="ʟᴏɢs", url="t.me/GreyLogs"),
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}","[SUPER SAIYAN GREY IS BACK](https://telegra.ph/file/d3db0babad0d1729c5f59.jpg)", parse_mode=ParseMode.MARKDOWN) 
        except Unauthorized:
            LOGGER.warning(
